...
async function gradesRoutes(
  ...
  // GET all grades with optional filters - PROTECTED
  fastify.get('/grades', 
  ...
  // GET grades by ID - PROTECTED
  fastify.get('/grades/:id', 
    { onRequest: [authenticate] },
    async (req: FastifyRequest, _reply: FastifyReply) => {
  ...
  // GET grades by student ID - PROTECTED
  fastify.get('/students/:studentID/grades', 
    { onRequest: [authenticate] },
    async (req: FastifyRequest, _reply: FastifyReply) => {
  ...
  // GET grade audit logs by student ID - PROTECTED
  fastify.get('/students/:studentID/grade-audit-logs', 
    { onRequest: [authenticate] },
    async (req: FastifyRequest, _reply: FastifyReply) => {
      const { studentID } = req.params as { studentID: string };
  ...
  // POST create a new grade record - PROTECTED
  fastify.post('/grades', 
    { onRequest: [authenticate] },
    async (req: FastifyRequest, _reply: FastifyReply) => {
  ...
  // PATCH update grade record - PROTECTED
  fastify.patch('/grades/:id', 
    { onRequest: [authenticate] },
    async (req: FastifyRequest, _reply: FastifyReply) => {
      const { id } = req.params as { id: string };
  ...
  // DELETE grade record - PROTECTED
  fastify.delete('/grades/:id', 
    { onRequest: [authenticate] },
    async (req: FastifyRequest, _reply: FastifyReply) => {
      const { id } = req.params as { id: string };
